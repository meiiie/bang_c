...
def list_agents(config: HarnessConfig) -> tuple[AgentSpec, ...]:
    return (
        ...
        AgentSpec(
            ...
            phase="runtime",
            mode="model-routed",
            description="Calls the allowed LLM family or deterministic dry-run fallback.",
            tools=("NVIDIA NIM OpenAI-compatible chat", "normalizer", "heuristic fallback"),
        ...
        AgentSpec(
            ...
            tools=("NVIDIA NIM OpenAI-compatible chat", "normalizer"),
        ...
        AgentSpec(
            ...
            phase="development",
            mode="provider probe",
            description="Lists provider models and filters them against Bang C model-family rules.",
